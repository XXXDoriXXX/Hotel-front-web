...
export const ClientStats = ({ data }) => (
    <div className="bg-white rounded-lg shadow p-4">
        <h4 className="text-lg font-semibold mb-2">Клієнти</h4>
        <p className="mb-8">Унікальних клієнтів: <strong>{data.unique}</strong></p>
        <p className="mb-4 font-bold">Топ клієнтів</p>
